//리뉴얼
//1.초기작업 : 회차select안옵션html 생성, document.querySelector('#회귀수입력').value=1;
//2.전체변수 최소화 : 색칠유형, 
//회차변경실행 ==> 왼쪽, 오른쪽 새롭게 생성 (코딩으로 부여된 클래스 지워짐[없도록])
//3.색칠유형에 따라 정보생성 
//  a)본인element 정의[없어도 변수 선언하기], 본인색칠, 색칠할번호들[] 정의
//4.색칠유형 관련 변수에 따라 색칠 
//  a)본인element 정의 있으면 본인색칠()
//  b)왼쪽에 색칠할번호들[] 색칠 : 왼쪽의 경우 색칠할 개수 기록하기 추가
// ---- 검토 : 최근회차 색칠한 상태에서 회차변경 일어나면....
//      1.색칠유형 변수값이 살아있는 상태에서
//      2.회차변경 실행되면 모든자료 새롭게 생성된다. (색칠하며 추가된 클래스 없어짐)  
//      3.3.색칠유형에 따라 정보생성, 4.색칠유형 관련 변수에 따라 색칠
