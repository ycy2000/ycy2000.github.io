...
var 리스너_자료_용어_중량전체 = document.querySelector('#자료_용어_중량전체');
...
function header_클릭시(e) {
  ...
  if (e.target.innerHTML == '자료_용어_중량') {//캔버스 들어가려면 클릭이 된다.
    선택한캔버스id='자료_용어_중량전체';
...
//리스너를 이것 저것으로 변경이 안됨??
리스너_자료_용어_중량전체.addEventListener('click', 선택한캔버스클릭시);
리스너_자료_용어_중량전체.addEventListener('change', 선택한캔버스_검색input_change시);
