...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20727;
  document.querySelector('#계산_더코').value = 25650;
  document.querySelector('#계산_하코').value = 30834;
  document.querySelector('#계산_대양저가').value = 32780;
  document.querySelector('#계산_대양고가').value = 40976;
  ...
  document.querySelector('#계산_사단까주').value = 15248;
