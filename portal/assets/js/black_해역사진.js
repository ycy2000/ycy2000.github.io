...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21021;
  document.querySelector('#계산_더코').value = 26014;
  document.querySelector('#계산_하코').value = 31271;
  document.querySelector('#계산_대양저가').value = 33246;
  document.querySelector('#계산_대양고가').value = 41557;
  ...
  document.querySelector('#계산_사단까주').value = 15464;
