...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21343;
  document.querySelector('#계산_더코').value = 26412;
  document.querySelector('#계산_하코').value = 31749;
  document.querySelector('#계산_대양저가').value = 33754;
  document.querySelector('#계산_대양고가').value = 42193;
  ...
  document.querySelector('#계산_사단까주').value = 15700;
