...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20904;
  document.querySelector('#계산_더코').value = 25869;
  document.querySelector('#계산_하코').value = 31096;
  document.querySelector('#계산_대양저가').value = 33060;
  document.querySelector('#계산_대양고가').value = 41325;
  ...
  document.querySelector('#계산_사단까주').value = 15377;
