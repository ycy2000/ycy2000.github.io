...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20815;
  document.querySelector('#계산_더코').value = 25759;
  document.querySelector('#계산_하코').value = 30965;
  document.querySelector('#계산_대양저가').value = 32920;
  document.querySelector('#계산_대양고가').value = 41150;
  ...
  document.querySelector('#계산_사단까주').value = 15313;
