...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20992;
  document.querySelector('#계산_더코').value = 25978;
  document.querySelector('#계산_하코').value = 31228;
  document.querySelector('#계산_대양저가').value = 33199;
  document.querySelector('#계산_대양고가').value = 41499;
  ...
  document.querySelector('#계산_사단까주').value = 15442;
