...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20756;
  document.querySelector('#계산_더코').value = 25687;
  document.querySelector('#계산_하코').value = 30878;
  document.querySelector('#계산_대양저가').value = 32827;
  document.querySelector('#계산_대양고가').value = 41034;
  ...
  document.querySelector('#계산_사단까주').value = 15269;
