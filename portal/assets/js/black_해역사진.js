...
document.querySelector('#적재가능일반무게').value = 26070;//새로고침시 무게 용맹무게??
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21050;
  document.querySelector('#계산_더코').value = 26050;
  document.querySelector('#계산_하코').value = 31314;
  document.querySelector('#계산_대양저가').value = 33291;
  document.querySelector('#계산_대양고가').value = 41614;
  ...
  document.querySelector('#계산_사단까주').value = 15485;
