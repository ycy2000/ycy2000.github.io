...
function 교섭력계산() {
  ...
  document.querySelector('#계산_더코').value = 26368;
  document.querySelector('#계산_하코').value = 31697;
  document.querySelector('#계산_대양저가').value = 33698;
  document.querySelector('#계산_대양고가').value = 42123;
  ...
  document.querySelector('#계산_사단까주').value = 15674;
