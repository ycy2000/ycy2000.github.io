...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21173;
  document.querySelector('#계산_더코').value = 26202;
  document.querySelector('#계산_하코').value = 31497;
  document.querySelector('#계산_대양저가').value = 33486;
  document.querySelector('#계산_대양고가').value = 41857;
  ...
  document.querySelector('#계산_사단까주').value = 15576;
