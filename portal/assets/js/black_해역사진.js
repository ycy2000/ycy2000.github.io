...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20668;
  document.querySelector('#계산_더코').value = 25577;
  document.querySelector('#계산_하코').value = 30746;
  document.querySelector('#계산_대양저가').value = 32687;
  document.querySelector('#계산_대양고가').value = 40859;
  ...
  document.querySelector('#계산_사단까주').value = 15204;
