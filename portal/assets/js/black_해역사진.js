...
document.querySelector('#적재가능일반무게').value = 20500;//새로고침시 무게 용맹무게??
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21453;
  document.querySelector('#계산_더코').value = 26549;
  document.querySelector('#계산_하코').value = 31914;
  document.querySelector('#계산_대양저가').value = 33929;
  document.querySelector('#계산_대양고가').value = 42412;
  ...
  document.querySelector('#계산_사단까주').value = 15782;
