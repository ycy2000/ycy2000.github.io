...
document.querySelector('#적재가능일반무게').value = 25570;//새로고침시 무게 용맹무게??
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21110;
  document.querySelector('#계산_더코').value = 26124;
  document.querySelector('#계산_하코').value = 31404;
  document.querySelector('#계산_대양저가').value = 33386;
  document.querySelector('#계산_대양고가').value = 41733;
  ...
  document.querySelector('#계산_사단까주').value = 15529;
