...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21141;
  document.querySelector('#계산_더코').value = 26163;
  document.querySelector('#계산_하코').value = 31450;
  document.querySelector('#계산_대양저가').value = 33436;
  document.querySelector('#계산_대양고가').value = 41795;
  ...
  document.querySelector('#계산_사단까주').value = 15552;
