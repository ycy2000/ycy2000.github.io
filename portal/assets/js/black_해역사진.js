...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21080;
  document.querySelector('#계산_더코').value = 26087;
  document.querySelector('#계산_하코').value = 31359;
  document.querySelector('#계산_대양저가').value = 33338;
  document.querySelector('#계산_대양고가').value = 41673;
  ...
  document.querySelector('#계산_사단까주').value = 15507;
