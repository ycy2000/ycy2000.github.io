...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20639;
  document.querySelector('#계산_더코').value = 25541;
  document.querySelector('#계산_하코').value = 30702;
  document.querySelector('#계산_대양저가').value = 32641;
  document.querySelector('#계산_대양고가').value = 40801;
  ...
  document.querySelector('#계산_사단까주').value = 15183;
