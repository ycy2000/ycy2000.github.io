...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20786;
  document.querySelector('#계산_더코').value = 25723;
  document.querySelector('#계산_하코').value = 30921;
  document.querySelector('#계산_대양저가').value = 32874;
  document.querySelector('#계산_대양고가').value = 41092;
  ...
  document.querySelector('#계산_사단까주').value = 15291;
