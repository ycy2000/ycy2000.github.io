...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 21273;
  document.querySelector('#계산_더코').value = 26325;
  document.querySelector('#계산_하코').value = 31645;
  document.querySelector('#계산_대양저가').value = 33643;
  document.querySelector('#계산_대양고가').value = 42054;
  ...
  document.querySelector('#계산_사단까주').value = 15649;
