...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20933;
  document.querySelector('#계산_더코').value = 25905;
  document.querySelector('#계산_하코').value = 31140;
  document.querySelector('#계산_대양저가').value = 33106;
  document.querySelector('#계산_대양고가').value = 41383;
