...
function 교섭력계산() {
  ...
  document.querySelector('#계산_하코저가').value = 20962;
  document.querySelector('#계산_더코').value = 25941;
  document.querySelector('#계산_하코').value = 31184;
  document.querySelector('#계산_대양저가').value = 33153;
  document.querySelector('#계산_대양고가').value = 41441;
  ...
  document.querySelector('#계산_사단까주').value = 15421;
