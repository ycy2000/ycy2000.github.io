...
function 임시_집구조켤때캔버스그리기() {
  ...
  //거실 네모
  그리기.fillStyle = 'rgba(128,128,128,0.4)';//회색
  가로=3270*숫자보정값;세로=3500*숫자보정값;X좌표=579;Y좌표=167;
  그리기.fillRect(X좌표,Y좌표,가로,세로);

  //거실 네모 오른쪽
  그리기.fillStyle = 'rgba(128,128,128,0.4)';//회색
  가로=3425*숫자보정값;세로=2370*숫자보정값;X좌표=906;Y좌표=167;
  그리기.fillRect(X좌표,Y좌표,가로,세로);

  //거실 네모 오른쪽 끝
  그리기.fillStyle = 'rgba(128,128,128,0.4)';//회색
  가로=1190*숫자보정값;세로=5000*숫자보정값;X좌표=1248;Y좌표=200;
  그리기.fillRect(X좌표,Y좌표,가로,세로);

  //싱크대쪽 위쪽 벽, 싱크대 오른쪽 벽, 세탁실 아래쪽 벽
  벽폭=22;//가로일수도 세로일수도
  그리기.fillStyle='black';
  가로=6010*숫자보정값;세로=벽폭;X좌표=766;Y좌표=145;//싱크대쪽 위쪽 벽,
  그리기.fillRect(X좌표,Y좌표,가로,세로);
  가로=벽폭;세로=5700*숫자보정값;X좌표=1367;Y좌표=145;//싱크대 오른쪽 벽
  그리기.fillRect(X좌표,Y좌표,가로,세로);
  가로=1410*숫자보정값;세로=벽폭;X좌표=1250;Y좌표=698;//세탁실 아래쪽 벽
  그리기.fillRect(X좌표-2,Y좌표,가로,세로);
  가로=100*숫자보정값;세로=벽폭;X좌표=1248;Y좌표=403;//세탁실 입구 왼쪽
  그리기.fillRect(X좌표,Y좌표,가로,세로);
  가로=600*숫자보정값;세로=벽폭;X좌표=1310;Y좌표=403;//세탁실 입구 오른쪽
  그리기.fillRect(X좌표,Y좌표,가로,세로);

  //싱크대
  가로=239;세로=58;X좌표=1127;Y좌표=167;//싱크대쪽 위쪽 벽,
  그리기.fillStyle = 'rgb(221, 235, 150)';//누런색
  그리기.strokeStyle='black'; // 선 말고 사각형으로채우기
  그리기.lineWidth='1';
  그리기.fillRect(X좌표,Y좌표,가로,세로);
  ...
  가로=66;세로=237;X좌표=1300;Y좌표=167;//싱크대쪽 위쪽 벽,
  그리기.fillStyle = 'rgb(221, 235, 150)';//누런색
  그리기.strokeStyle='black'; // 선 말고 사각형으로채우기
  그리기.lineWidth='1';
  그리기.fillRect(X좌표,Y좌표,가로,세로);
...
가로=3270*숫자보정값;세로=3500*숫자보정값;X좌표=576;Y좌표=167;//거실 네모
  그리기.beginPath();
  그리기.strokeStyle='yellow';
  그리기.lineWidth=2;
  그리기.setLineDash([2,8]);
  ...
  그리기.stroke();
  그리기.fillStyle='yellow';
  그리기.fillText('327cm',X좌표+(가로/2),Y좌표+60);
  ...
  그리기.fillText('0',X좌표+115,Y좌표+100+30);
  ...
  그리기.fillText('7',X좌표+3,Y좌표+60+15);
  그리기.fillText('9',X좌표+3,Y좌표+60+30);
  그리기.fillText('cm',X좌표,Y좌표+60+45);
  그리기.fillRect(X좌표-10,Y좌표-3,20,3);
  그리기.fillRect(X좌표-10,Y좌표+세로-2,20,3);

  그리기.beginPath();//옷방왼쪽부터 싱크대왼쪽까지
  그리기.strokeStyle='red';
  그리기.lineWidth=2;
  가로=220;X좌표=905;Y좌표=265;
  그리기.setLineDash([2,2]);//[2,8]
  그리기.moveTo(X좌표,Y좌표);
  그리기.lineTo(X좌표+가로,Y좌표);
  그리기.stroke();
  그리기.fillStyle='red';
  그리기.fillText('???cm',X좌표+80,Y좌표+3);
  그리기.fillRect(X좌표,Y좌표-10,3,20);
  그리기.fillRect(X좌표+가로,Y좌표-10,3,20);

  그리기.fillStyle='gray';
  X좌표=1305;Y좌표=167;//가스레인지
